...
export const ALL_PROMPTS: AraayePrompt[] = [
  ...
  p({
    ...
    tags: ["python","debug"],
    intentPhrase: "پرامپت برای دیباگ پایتون",
    shortDescription:
...
6) نکته پیشگیری: برای عملیات روی collection، حالت خالی را صریح handle کن.`,
  ...
  p({
    ...
    category: "programming",
    tags: ["sql"],
    intentPhrase: "پرامپت برای نوشتن SQL",
...
منطق: join مشتری و سفارش، فیلتر پرداخت و بازه زمانی، سپس having برای حداقل ۲ سفارش.`,
  ...
  p({
    ...
    category: "programming",
    tags: ["code-review"],
    intentPhrase: "پرامپت برای Code Review",
    shortDescription:
...
چک‌لیست merge: parameterized SQL، hashing، validation، تست duplicate.`,
  ...
  p({
    ...
    category: "programming",
    tags: ["javascript"],
    intentPhrase: "پرامپت برای نوشتن تابع جاوااسکریپت",
    shortDescription:
...
median([4, 1, 3, 2]) // 2.5`,
  ...
  p({
    ...
    category: "programming",
    tags: ["regex"],
    intentPhrase: "پرامپت برای نوشتن Regex",
    shortDescription:
...
نکته JS: با RegExp یا literal؛ نیازی به flag i نیست.`,
  ...
  p({
    ...
    category: "writing",
    tags: ["career","resume"],
    intentPhrase: "پرامپت برای ساخت رزومه",
    shortDescription:
...
نسخه کوتاه: Frontend Developer | React/TS | Performance-focused | ۳ سال تجربه`,
  ...
  p({
    ...
    category: "writing",
    tags: ["career"],
    intentPhrase: "پرامپت برای نوشتن کاورلتر",
...
[Your Name]`,
  ...
  p({
    ...
    intentPhrase: "پرامپت برای بیو لینکدین",
...
نسخه کوتاه: سئوی محلی برای کلینیک‌ها؛ تمرکز روی نقشه، صفحات خدمت و جذب نوبت.`,
  ...
  p({
    ...
    category: "writing",
    tags: ["career"],
    intentPhrase: "پرامپت برای آمادگی مصاحبه",
    shortDescription:
...
سؤال از مصاحبه‌گر: موفقیت ۹۰ روز اول این نقش را چطور می‌سنجید؟`,
  ...
  p({
    ...
    category: "business",
    tags: ["career","hr"],
    intentPhrase: "پرامپت برای شرح شغل",
    shortDescription:
...
نسخه اجتماعی: دنبال نویسنده محتوا برای SaaS B2B هستیم — پاره‌وقت، تمرکز روی مقاله و لینکدین.`,
  ...
  p({
    ...
    category: "social",
    tags: ["instagram"],
    intentPhrase: "پرامپت برای تولید پست اینستاگرام",
...
هشتگ‌ها: #سئومحلی #کلینیک #نوبت‌دهی ...`,
  ...
  p({
    ...
    category: "social",
    tags: ["telegram"],
    intentPhrase: "پرامپت برای پست تلگرام",
...
CTA: از araaye.com/ai شروع کن.`,
  ...
  p({
    ...
    category: "marketing",
    tags: ["seo"],
    intentPhrase: "پرامپت برای نوشتن مقاله سئو",
    shortDescription:
...
مقدمه نمونه: اگر بیمار نزدیک شماست ولی مسیر تماس روشن نیست، مشکل معمولاً از دیده‌شدن محلی است نه فقط تبلیغ بیشتر.`,
  ...
  p({
    ...
    category: "marketing",
    tags: ["ads"],
    intentPhrase: "پرامپت برای تبلیغات",
...
زاویه: کاهش تردید انتخاب مدل`,
  ...
  p({
    ...
    category: "marketing",
    tags: ["ecommerce"],
    intentPhrase: "پرامپت برای توضیح محصول",
...
- صفحات خدمت → تطبیق با جستجوی نیاز بیمار`,
  ...
  p({
    ...
    category: "business",
    tags: ["legal"],
    intentPhrase: "پرامپت برای نوشتن قرارداد",
    shortDescription:
...
باید چک شود: مالیات، تأخیر طرفین، میزبانی و محتواهای پزشکی.`,
  ...
  p({
    ...
    category: "business",
    tags: ["strategy"],
    intentPhrase: "پرامپت برای بیزینس پلن",
...
۹۰ روز: مصاحبه ۱۰ کلینیک، پکیج استاندارد، ۲ کیس‌استادی.`,
  ...
  p({
    ...
    category: "business",
    tags: ["support"],
    intentPhrase: "پرامپت برای پیام مشتری",
...
نسخه کوتاه: یادآوری دموی فردا — اگر نیاز به تغییر ساعت بود بگویید.`,
  ...
  p({
    ...
    category: "business",
    tags: ["sales"],
    intentPhrase: "پرامپت برای پیگیری فروش",
...
Breakup: همین‌جا فایل پیشنهاد را می‌بندم؛ هر وقت آماده بودید خوشحال می‌شوم ادامه دهیم.`,
  ...
  p({
    ...
    category: "business",
    tags: ["local-seo"],
    intentPhrase: "پرامپت برای پاسخ نظر گوگل",
    shortDescription:
...
یادداشت داخلی: بله — پیگیری توسط مدیر پذیرش؛ بررسی علت غیبت پزشک و زمان انتظار.`,
  ...
  p({
    ...
    category: "business",
    tags: ["sales"],
    intentPhrase: "پرامپت برای نوشتن پروپوزال",
...
مراحل بعدی: تأیید scope، پیش‌پرداخت، kickoff.`,
  ...
  p({
    ...
    category: "writing",
    tags: ["email"],
    intentPhrase: "پرامپت برای نوشتن ایمیل رسمی",
...
بدنه: لندینگ طبق موارد توافق‌شده تحویل شد. اگر ۱۰ دقیقه فرصت دارید، بگویید کدام بخش نیاز به تنظیم دارد تا در دور بازبینی اعمال کنیم.`,
  ...
  p({
    ...
    category: "language",
    tags: ["translation"],
    intentPhrase: "پرامپت برای ترجمه فارسی",
...
نکته: overpromising rankings به «وعده رتبه‌های قطعی» برگردانده شد تا طبیعی باشد.`,
  ...
  p({
    ...
    category: "writing",
    tags: ["summary"],
    intentPhrase: "پرامپت برای خلاصه کردن متن",
...
اقدام: ارسال پیش‌نویس محتوا تا چهارشنبه؛ تأیید نهایی پزشک.`,
  ...
  p({
    ...
    category: "writing",
    tags: ["rewrite"],
    intentPhrase: "پرامپت برای بازنویسی متن",
...
تغییرات: حذف تردید اضافی، تمرکز روی مقایسه مدل‌ها، جمله کوتاه‌تر.`,
  ...
  p({
    ...
    tags: ["brainstorm"],
    intentPhrase: "پرامپت برای ایده‌پردازی",
...
قدم اول: انتخاب ۴ پرامپت اول و انتشار یک پست تلگرام.`,
  ...
  p({
    ...
    category: "design",
    tags: ["image","logo"],
    intentPhrase: "پرامپت برای طراحی لوگو",
    shortDescription:
...
نتیجه: ایده اولیه علامت — برای SVG نهایی به طراح ارجاع دهید.`,
  ...
  p({
    ...
    category: "design",
    tags: ["image"],
    intentPhrase: "پرامپت برای عکس محصول",
...
Negative: extra bottles, deformed glass, harsh shadows, cluttered props`,
  ...
  p({
    ...
    intentPhrase: "پرامپت برای پوستر اینستاگرام",
...
Feed 1:1 / Story 9:16 variants included.`,
  ...
  p({
    ...
    category: "design",
    tags: ["image"],
    intentPhrase: "پرامپت برای ساخت آواتار",
...
Variants: formal glasses / warmer colors`,
  ...
  p({
    ...
    category: "design",
    tags: ["image"],
    intentPhrase: "پرامپت برای تصویر واقع‌گرایانه",
