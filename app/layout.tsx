...
export const metadata: Metadata = {
  ...
  description:
    "آرایه با طراحی سایت، سئو، نرم‌افزار اختصاصی و راهکارهای هوش مصنوعی به کسب‌وکارها کمک می‌کند بهتر دیده شوند و سریع‌تر رشد کنند.",
  keywords: [
    "شرکت آرایه",
    "آرایه",
    "شرکت هوش آرایه پارس",
  ...
  openGraph: {
    ...
    description:
      "از طراحی سایت و سئو تا نرم‌افزار اختصاصی و هوش مصنوعی؛ راهکارهای دیجیتال برای دیده‌شدن، جذب مشتری و رشد کسب‌وکار.",
    type: "website",
    url: canonicalUrl("/"),
    locale: "fa_IR",
    siteName: SITE_NAME,
  ...
  twitter: {
    ...
    title: "آرایه | طراحی سایت، سئو و توسعه نرم‌افزار",
    description:
      "راهکارهای یکپارچه طراحی سایت، سئو، نرم‌افزار و هوش مصنوعی برای رشد کسب‌وکار.",
