  ...
  if (!campaign || !ad) {
    return (
      <div className="text-center py-20 text-slate-500" dir="rtl">
        <p>کمپین یافت نشد</p>
        <Link href="/admin/manager/campaigns" className="text-blue-600 text-sm mt-2 inline-block">بازگشت</Link>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col gap-6" dir="rtl">
      <AdminPageHeader
        ...
        icon={Megaphone}
        breadcrumb={[{ label: 'مدیریت' }, { label: 'کمپین‌ها', href: '/admin/manager/campaigns' }, { label: campaign.name }]}
        actions={
          <Link href="/admin/manager/campaigns" className="flex items-center gap-1.5 text-sm text-slate-600 hover:text-slate-900">
