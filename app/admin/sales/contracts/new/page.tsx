...
export default function SalesNewContractPage() {
  ...
  return (
    <div className="flex flex-col gap-6" dir="rtl">
      <AdminPageHeader
        ...
        icon={FileCheck}
        breadcrumb={[{ label: 'فروش' }, { label: 'قراردادها', href: '/admin/sales/contracts' }, { label: 'جدید' }]}
        actions={
          <Link href="/admin/sales/contracts" className="flex items-center gap-1.5 text-sm text-slate-600 hover:text-slate-900">
      ...
      <div className="bg-white border border-slate-200 rounded-xl shadow-sm p-6 max-w-2xl">
        <form
          ...
          onSubmit={async (e) => {
            ...
            if (contractId) {
              router.push(`/admin/sales/contracts/${contractId}`);
            } else {
              router.push('/admin/sales/contracts');
            }
          }}
        >
          <Field label="مشتری">
