    ...
    <section className="section-py bg-navy-50/40">
      <div className="container-mx container-px">
        <SectionHeader
          ...
          subtitle="ما سایت را فقط به‌عنوان مجموعه‌ای از صفحات طراحی نمی‌کنیم. ساختار پیام، مسیر اقدام، فرم‌های جذب لید، سرعت، سئو و تحلیل رفتار کاربر از ابتدا بخشی از پروژه هستند."
        />
