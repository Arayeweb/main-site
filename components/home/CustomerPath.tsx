const cards = [
  {
    ...
    number: "۱",
    product: "طراحی سایت",
    title: "سایتی که مشتری را سردرگم نکند",
    description:
      "یک سایت واضح و مرتب می‌سازیم تا مشتری سریع خدمات شما را بفهمد و راحت تماس بگیرد.",
    cta: "مشاهده طراحی سایت",
    href: "#cta",
  },
  {
    key: "seo",
    number: "۲",
    product: "آرایه SEO",
    title: "وقتی جست‌وجو می‌کنند، شما را پیدا کنند",
    description:
      "کمک می‌کنیم وقتی مشتری در گوگل جست‌وجو می‌کند، راحت‌تر شما را پیدا کند.",
  ...
  },
  {
    ...
    number: "۳",
    product: "AdReady",
    title: "برای تبلیغات، سریع صفحه فروش بسازید",
    description:
      "یک صفحه فروش سریع برای تبلیغات می‌سازیم تا بازدیدکننده مستقیم تبدیل به تماس یا درخواست شود.",
    cta: "مشاهده AdReady",
    href: "/adready",
  },
] as const;
      ...
      <div className="mx-auto max-w-[1180px] px-5 sm:px-8 lg:px-10">
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-2xl font-extrabold leading-snug tracking-tight text-navy-900 sm:text-3xl">
            برای گرفتن مشتری، این ۳ بخش باید کنار هم باشند
          </h2>
          <p className="mt-3 text-base leading-relaxed text-navy-500 sm:text-[1.05rem]">
            سایت شما را می‌سازیم، کمک می‌کنیم در گوگل دیده شوید و مسیر تماس و پیگیری مشتری را
            آماده می‌کنیم.
          </p>
        </div>
