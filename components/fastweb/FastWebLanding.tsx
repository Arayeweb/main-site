...
import FastWebDemoHomePreview from "@/components/fastweb/demo/FastWebDemoHomePreview";
    ...
    <div className="overflow-hidden rounded-2xl border border-navy-100 bg-white shadow-card">
      <div className="flex items-center gap-2 border-b border-navy-100 bg-navy-50/70 px-4 py-2.5">
        ...
        <span className="mr-auto truncate rounded-md bg-white px-3 py-1 text-[11px] font-medium text-navy-400 ring-1 ring-navy-100">
          {FASTWEB_FEATURED_DEMO.browserBar}
        </span>
      </div>
          ...
          <div className="container-mx container-px py-14 sm:py-20 lg:py-24">
            <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              ...
              <div className="lg:ps-2">
                <Link
                  href={FASTWEB_FEATURED_DEMO.previewUrl}
                  className="block transition hover:opacity-[0.98] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2"
                  aria-label="مشاهده دموی کامل سایت فوری"
                >
                  <BrowserFrame>
                    <FastWebDemoHomePreview />
                  </BrowserFrame>
                </Link>
                <p className="mt-3 text-center">
                  <Link
                    href={FASTWEB_FEATURED_DEMO.previewUrl}
                    className="text-xs font-bold text-teal-700 underline decoration-teal-200 underline-offset-4 transition hover:text-teal-800"
                  >
                    مشاهده دمو
                  </Link>
                </p>
