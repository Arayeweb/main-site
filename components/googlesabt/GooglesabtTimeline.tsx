const STEPS = [
  {
    n: "۱",
    title: "ثبت درخواست",
    description: "فرم کوتاه را تکمیل کنید و اطلاعات اولیه کسب‌وکار را ارسال کنید.",
  },
  {
    n: "۲",
    title: "بررسی و راه‌اندازی",
    description: "اطلاعات بررسی و حضور آنلاین کسب‌وکار شما راه‌اندازی می‌شود.",
  },
  {
    n: "۳",
    title: "تحویل نهایی",
    description: "لینک‌ها، اطلاعات و خروجی نهایی برای استفاده در اختیار شما قرار می‌گیرد.",
  },
] as const;
